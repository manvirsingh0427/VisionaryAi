...
const Result = () => {
  ...
  return (
    ...
    onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] items-center justify-center' action="">
    <div>
...
{isImageLoaded &&
    ...
    text-white text-sm p-0.5 mt-10 rounded-full'>
      ...
      <a className='bg-zinc-900 px-10
      py-3 rounded-full cursor-pointer'
      download href={image}>Download</a>
    </div>
}
    </motion.form>
  )
