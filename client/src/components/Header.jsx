...
const Header = () => {
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:max-w[590]
      ...
      <motion.p className = 'text-center max-w-xl mx-auto text-stone-600 mt-5'
      ...
      <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 
      ...
      className='mt-2 text-neutral-600'>Genrated images from VisionaryAi</motion.p>
    </motion.div>
  )
}
